    ...
    <div id="loading-center">
        <div id="loading-center-absolute">
            ...
            <div class="text-holder text-center">
                <h2>MENTOR</h2>
                <h6>Senior Developer / Software Architect</h6>
            </div>
        </div>
    </div>
</div>
                ...
                <div id="v-card" class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="info-headings">
                            <h4 class="text-uppercase left">MEENTOR PROFILE</h4>
                            <h6 class="text-capitalize left">Senior Developer / Software Architect</h6>
                        </div>
